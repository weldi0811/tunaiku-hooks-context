...
const TestSlider = () => {
    ...
    const {loanInfo, setLoanInfo} = useContext(ApplyFormContext)
    ...
    const handleLoanAmountChange = (event, value) => {
        setLoanInfo({ ...loanInfo, loanAmount: value, loanInstallment: calculateInstallments() })
    }


    const handleLoanPeriodChange = (event, value) => {
        setLoanInfo({ ...loanInfo, loanPeriod: value, loanInstallment: calculateInstallments() })
    }
